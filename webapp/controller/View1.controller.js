sap.ui.define([
    "zcursoecapp2/controller/App.controller",
    ...
    function (Controller, JSONModel, MLibrary, MessagePopover, UIColumn, FilterOperator, Filter, MessageItem,) {
        ...
        return Controller.extend("zcursoecapp2.controller.View1", {
            onInit: function () {
            ...
            onValueHelpUser: function () {
                ...
                if (!this.pDialog) {
                    this.pDialog = this.loadFragment({
                        name: "zcursoecapp2.view.fragmentos.ValueHelpUser"
                    });
                }
            ...
            acessaGitHub: function () {
                let URLHelper = MLibrary.URLHelper;
                URLHelper.redirect("https://github.com/EdsonCruzz/zcursoecapp1", true);
            },
                            ...
                            sap.m.MessageBox.alert("Confirma a inclusão?", {
                                ...
                                onClose: function (sAction) {
                                    if (sAction == "Sim") {
                                        ...
                                        oModel.create('/AlunosFioriEDSONCRSet', objeto, {
                                            success: function (oData, oReponse) {
                                                let arrayMsg = {
                                                    type: "Success",
