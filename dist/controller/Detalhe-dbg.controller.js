sap.ui.define([
    ...
    function (Controller, JSONModel, MessageBox) {
        ...
        return Controller.extend("zcursoecapp2.controller.Detalhe", {
            onInit: function () {
            ...
            _onObjectMatched: function (oEvent) {
                ...
                this.getModel().metadataLoaded().then(function () {
                    var sObjectPath = this.getModel().createKey("AlunosFioriEDSONCRSet", {
                        Usuario: id
                    });
            ...
            onSalva: function () {
                ...
                this.getView().getModel().update("/AlunosFioriEDSONCRSet('" + chave + "')", objeto, {
